...
public abstract class Board {
	...
	/**
	 * Method to be completed by the concrete class that determines if the selected
	 * cards form a valid group for removal.
	 * 
	...
	/**
	 * Method to be completed by the concrete class that determines if there are any
	 * legal plays left on the board.
	 * 
