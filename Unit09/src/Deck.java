...
public class Deck {
	 ...
	 * one of the corresponding card. * @param ranks is an array containing all of
	 * the card ranks. * @param suits is an array containing all of the card suits.
	...
	/**
	 * * Determines if this deck is empty (no undealt cards). * @return true if this
	 * deck is empty, false otherwise.
	 */
	...
	/**
	 * * Accesses the number of undealt cards in this deck. * @return the number of
	 * undealt cards in this deck.
	 */
	public int size() {
		return size;
	}
